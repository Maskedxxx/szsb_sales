...
def check_calorie_range(kbgu_text: str, enum_value: str) -> bool:
    ...
    try:
        ...
        # Исходные диапазоны из ready_sauces
        ...
        elif enum_value == "низкокалорийные_до_200":
            return calories < 200
        elif enum_value == "до_250":
            return calories < 250
        elif enum_value == "250_300":
            return 250 <= calories <= 300
        elif enum_value == "свыше_300":
            return calories > 300
        elif enum_value == "до_150":
            return calories < 150
        elif enum_value == "150_250":
            return 150 <= calories <= 250
        elif enum_value == "250_400":
            return 250 <= calories <= 400
        elif enum_value == "низкие_до_100":
            return calories < 100
        elif enum_value == "высокие_250_300":
            return 250 <= calories <= 300
        elif enum_value == "средние_200_300":
            return 200 <= calories <= 300
        elif enum_value == "высокие_300_400":
            return 300 <= calories <= 400
        elif enum_value == "средние_250_300":
            return 250 <= calories <= 300
...
def check_fat_content(kbgu_text: str, enum_value: str) -> bool:
    ...
    try:
        ...
        # Дополнительные диапазоны
        elif enum_value == "низкожирные_до_5":
            return 0 <= fat_content <= 5
        elif enum_value == "низкожирные_до_20":
            return 0 <= fat_content <= 20
        elif enum_value == "среднежирные_15_25":
            return 15 <= fat_content <= 25
        elif enum_value == "среднежирные_20_25":
            return 20 <= fat_content <= 25
        elif enum_value == "высокожирные_свыше_25":
            return fat_content > 25
...
UNIVERSAL_KBGU_CHECKERS: Dict[str, Callable[[str, str], bool]] = {
    ...
    "средние_200_300": check_calorie_range,
    "высокие_300_400": check_calorie_range,
    "средние_250_300": check_calorie_range,
